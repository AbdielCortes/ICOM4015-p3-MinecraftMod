package abdielandwolf.ste_men.energy;

import net.minecraft.nbt.NBTTagCompound;
import net.minecraftforge.energy.EnergyStorage;

public class ManaStorage extends EnergyStorage {
    ...
    public ManaStorage(int capacity, int maxReceive, int maxExtract, int energy)
    {
